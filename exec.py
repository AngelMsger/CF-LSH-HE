...
from utils import read_with_cache, mean_1d, evaluate, plot_and_save
...
def test_lsh(collection, lsh_hashes, offset=64, step=64, test_count=64) -> None:
    ...
    effectiveness_mean_using_lsh = mean_1d(effectiveness_using_lsh)
    effectiveness_mean_not_using_lsh = mean_1d(effectiveness_not_using_lsh)
    ...
    mae_mean_using_lsh = mean_1d(mae_using_lsh)
    mae_mean_not_using_lsh = mean_1d(mae_not_using_lsh)
...
def test_he(collection, lsh_hashes, test_count=64) -> None:
    ...
    # 打印预测结果
    print(mean_1d(effectiveness_using_he), mean_1d(effectiveness_not_using_he))
    print(mean_1d(mae_using_he), mean_1d(mae_not_using_he))
